...
public enum TeleportEnum 
{
    ...
    RA(4272,2,"Golden Knights",new Position(2403,3482),"@mag@Boss"),
    ...
    DOOMS_DAY(185,2,"Dooms Day",new Position(3420, 5276),"@mag@Boss"),
    ...
    TZHAAR(2745, 3,"Tzhaar Dungeon", new Position(2445,5178),"@red@Tzhaar Dungeon"),
    BARROWS(2026, 3,"The Brothers", new Position(3565,3306),"@gre@Barrow Brothers"),
    PC(3782, 3,"Pest Control", new Position(2658,2661),"@gre@Pest Control"),
    GALACTIC_TITAN(1016,4,"Galactic Titans",new Position(3683, 3615, 0),"@red@Multi Boss"),
    ...
    FALLENGOD(1039,4,"Fallen God",new Position(3421,3996),"@red@Multi Boss"),
    TORMENT_KNIGHT(1038,4,"Knight of Torment",new Position(3237,3042),"@red@Multi Boss"),
    THE_LITCH(1494,4,"The Litch",new Position(2517, 10147),"@red@Multi Boss"),
    SPUDERMAN(3012,4,"Spuderman",new Position(3376, 3214),"@red@Multi Boss"),
    DR_STRANGE(3007,4,"Dr. Strange",new Position(2272, 4696),"@red@Multi Boss"),
    GODS_RULER(1511,4,"Gods Ruler",new Position(3038, 5348),"@red@Multi Boss"),
    GOLDEN_FREEZA(5148,4,"Golden Freeza",new Position(2403, 2965),"@red@Multi Boss"),
    ...
    AnimeRaid(1500,5,"Anime Raids",new Position(3056, 2840),"@red@Anime @whi@Raid"),
    MortalKombatRaid(1492,5,"Mortal kombat Raids",new Position(2846, 3102),"@red@Mortal @yel@Kombat @whi@Raids"),
    DarkDimensionRaid(200,5,"Dark Dimension Raids",new Position(3360, 3242),"@bla@Dark @mag@Dimension @whi@Raids"),
    EVENTS(1041,6,"Spawned Events",new Position(3555,3106),"@or1@Spawned Events"),
