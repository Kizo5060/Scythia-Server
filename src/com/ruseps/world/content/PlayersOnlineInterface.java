...
public class PlayersOnlineInterface {
	...
	private static void clearInterface(Player player) {
		...
		player.getPacketSender().sendString(57023, "Arena Losses:");
	}
	...
	public static void updateInterface(Player player, int index) {
		...
		sendString(57022, "BattleRoyale: @whi@"+player2.getPointsHandler().getBattleRoyalPoints()).sendString(57023, "Arena Losses: @whi@"+player2.getDueling().arenaStats[1]);
	}
