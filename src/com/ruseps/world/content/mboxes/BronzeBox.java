...
public class BronzeBox {

	/**
	 * The player object that will be triggering this event
	 */
	private final Player plr;
	private final int BOX = 6855;
	...
	public void spin() {
		...
		if (!plr.getInventory().contains(BOX)) {
			plr.sendMessage("You require a Bronze box to do this.");
			return;
		}
	...
	public static int loot[][] = { {21029, 21030, 21031, 21032, 21033, 21026, 21004, 21005, 21006 },
			 { 19918, 11005, 10480, 19921, 10503, 11654, 18057 },
			{ 21000, 21001, 21002, 21003, 21016, 21017, 21018, 21019, 21020, 21021, },
			{ 19103, 19104, 19105, 19108, 19109 },
			{19110, 19112, 19113, 19114, 19115,10942,6856,18958 }};
	...
	public void process() {
		...
		int[] common = { 19098, 19100, 19099, 19093, 19096, 938, 19097, 915 };
		int[] uncommon = { 21023, 21024, 21025, 21027, 21028, 21007, 21008, 21009, 21010, 21011, 21012 };
		int[] veryUncommon = { 21029, 21030, 21031, 21032, 21033, 21026, 21004, 21005, 21006 };
		int[] rare = { 19918, 11005, 10480, 19921, 10503, 11654, 18057 };
		int[] veryRare = { 21000, 21001, 21002, 21003, 21016, 21017, 21018, 21019, 21020, 21021, };
		int[] extremelyRare = { 19103, 19104, 19105, 19108, 19109 };
		int[] legendary = {19110, 19112, 19113, 19114, 19115,10942,6856,18958 };
 //10$ 10942 
