...
public class SilverBox {
	...
	public static int loot[][] = {
			{ 11896, 21057, 21058, 21059, 21060, 21061, 21062, 21063, 21064 }, { 2768, 2769, 2770, 2771, 2772, 2789 },
			{ 2773, 2775, 2777, 2779, 2781, 2784, 2787, 18958 }, { 21049, 21050, 21051, 21052, 21053, 21054, 2749, 2751,
					2753, 2756, 2754, 2755, 18057, 17658, 17654, 10942, 10934, 6853, 18961 } };
	...
	public void spin() {
		...
		if (!plr.getInventory().contains(BOX)) {
			plr.sendMessage("You require a Silver box to do this.");
			return;
		}
	...
	public void process() {
		...
		int[] common = { 1031, 1033, 1035, 11896, 21057, 21058, 21059, 21060, 21061, 21062, 21063, 21064};
		int[] uncommon = { 19106, 19107, 19117, 19118, 19119, 19120, 19121, 19122};
		int[] veryUncommon = { 21029, 21030, 21031, 21032, 21033, 21026, 21004, 21005, 21006 };
		int[] rare = { 11896, 21057, 21058, 21059, 21060, 21061, 21062, 21063, 21064 };
		int[] veryRare = {  2768, 2769, 2770, 2771, 2772, 2789 };
		int[] extremelyRare = { 2773, 2775, 2777, 2779, 2781, 2784, 2787,18958 };
		int[] legendary = {21049, 21050, 21051, 21052, 21053, 21054, 2749, 2751, 2753, 2756, 2754, 2755, 18057, 17658, 17654 ,10942, 10934,6853,18961  };
 //10$ 10942 
	...
	//	//new Thread(() -> {  
		...
		int[] veryRare = {  2768, 2769, 2770, 2771, 2772, 2789 };
		int[] extremelyRare = { 2773, 2775, 2777, 2779, 2781, 2784, 2787,18958 };
		int[] legendary = {21049, 21050, 21051, 21052, 21053, 21054, 2749, 2751, 2753, 2756, 2754, 2755, 18057, 17658, 18961,17654 ,10942, 10934,6853 };
		int boxId = BOX;
