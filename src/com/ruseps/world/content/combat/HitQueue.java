				...
				if(attacker.isPlayer()) {
					...
					if(damage > 0) {
						...
						if(container.getCombatType() == CombatType.MELEE) {
							p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_EASY_DAMAGE_USING_MELEE, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_MEDIUM_DAMAGE_USING_MELEE, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_HARD_DAMAGE_USING_MELEE, damage);
						} else if(container.getCombatType() == CombatType.RANGED) {
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_EASY_DAMAGE_USING_RANGED, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_MEDIUM_DAMAGE_USING_RANGED, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_HARD_DAMAGE_USING_RANGED, damage);
						} else if(container.getCombatType() == CombatType.MAGIC) {
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_EASY_DAMAGE_USING_MAGIC, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_MEDIUM_DAMAGE_USING_MAGIC, damage);
	                        p.getAchievementTracker().progress(com.ruseps.world.content.achievements.AchievementData.DEAL_HARD_DAMAGE_USING_MAGIC, damage);
						}
						if(victim.isPlayer()) {
