...
public enum FightType {
    ...
    CRAZYBOW_ACCURATE(426, 43, 0, BonusManager.ATTACK_RANGE, FightStyle.ACCURATE),
    CRAZYBOW_RAPID(426, 43, 1, BonusManager.ATTACK_RANGE, FightStyle.AGGRESSIVE),
    CRAZYBOW_LONGRANGE(426, 43, 2, BonusManager.ATTACK_RANGE, FightStyle.DEFENSIVE),
    ...
    EXOTICSWORD_CHOP(15071, 43, 0, BonusManager.ATTACK_SLASH, FightStyle.ACCURATE),
    EXOTICSWORD_SLASH(15071, 43, 1, BonusManager.ATTACK_SLASH, FightStyle.AGGRESSIVE),
    EXOTICSWORD_LUNGE(15072, 43, 2, BonusManager.ATTACK_STAB, FightStyle.CONTROLLED),
    EXOTICSWORD_BLOCK(15071, 43, 3, BonusManager.ATTACK_SLASH, FightStyle.DEFENSIVE),
    ...
    HALBERD_JAB(440, 43, 1, BonusManager.ATTACK_STAB, FightStyle.CONTROLLED),
    HALBERD_SWIPE(440, 43, 2, BonusManager.ATTACK_SLASH, FightStyle.AGGRESSIVE),
    HALBERD_FEND(440, 43, 0, BonusManager.ATTACK_STAB, FightStyle.DEFENSIVE),
