...
public class NightmareRotator {
    ...
    public static enum LocationData {
       ...
       CHEST_LOCATION_1(new Position(3283, 9837, 0), ""),
       CHEST_LOCATION_2(new Position(3273, 9831, 0), ""),
       CHEST_LOCATION_3(new Position(3269, 9844, 0), ""),
       CHEST_LOCATION_4(new Position(3281, 9850, 0), ""),
       CHEST_LOCATION_5(new Position(3268, 9852, 0), ""),
       CHEST_LOCATION_6(new Position(3268, 9838, 0), ""),
       CHEST_LOCATION_7(new Position(3281, 9833, 0), "");
