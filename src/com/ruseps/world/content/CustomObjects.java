...
public class CustomObjects {
	...
	private static final int[][] CLIENT_OBJECTS = {
			...
			{2213, 3035, 2803, 0, 0}, //new bank booth
			{2213, 3035, 2790, 0, 0}, //new bank booth
			{2213, 3037, 2803, 0, 0}, //new bank booth
			{2213, 3039, 2803, 0, 0}, //new bank booth
			{2213, 3041, 2803, 0, 0}, //new bank booth
			{2213, 3043, 2803, 0, 0}, //new bank booth
			{2213, 3045, 2803, 0, 0}, //new bank booth
			
			{409, 3041, 2790, 0, 2}, //altar
			{61, 3043, 2790, 0, 2}, //chaos altar
			{9159, 3045, 2790, 0, 1}, //candles
			{4002, 3031, 2788, 0, 3}, //fuser machine
			{3008, 3031, 2786, 0, 3}, //upgrade machine
			{2654, 3038, 2782, 0, 3}, //Well of Goodwill
			...
			// to do { 62, 1298, 1248, 0, 0}, // giant crystal
			// to do { 62, 1298, 1246, 0, 0}, // giant crystal
			// to do { 62, 1298, 1244, 0, 0}, // giant crystal
	...
	private static final int[][] CUSTOM_OBJECTS_SPAWNS = {
			...
			{4928, 2665, 2797, 0,0},
			{4928, 2665, 2798, 0,0},
			{1994, 2674, 2785, 0, 1}, //ds chest
			{778, 2670, 2782, 0, 1}, // ds entrance
			...
			{3011, 3363, 3242, 0, 0}, //Dark Demention door
			{4123, 3361, 3239, 0, 0}, //Dark Demention chest
			...
			{3008, 3282, 2893, 0, 0},
			{3010, 3061, 2840, 0, 0},
			{5273, 3172, 9760, 0, 2}, // Owner Chest
			{5274, 2550, 3756, 0, 0},
			{5275, 2547, 3756, 0, 0},
			{5278, 2545, 3756, 0, 0},
			{5279, 3165, 9760, 0, 0}, // Slayer Chest
