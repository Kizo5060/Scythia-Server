package com.ruseps.world.content.new_raids_system.raids_loot.raids_three_loot.phase_three;
 ...
 *
 */
public class R3PhaseThreePoints extends NPC {
	 ...
	 * The npc id.
	 */
	public static final int FIRST_NPC_ID = 175;
	 ...
	 *            The position.
	 */
	public R3PhaseThreePoints(Position position) {
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		World.sendMessage("<img=469> <col=dbffba><shad=1>"+player.getUsername()+ " received loot from Raids #1 during Phase One!");
		...
		if (chance > 99) {
			player.getPointsHandler().incrementRaidsOnePoints(20);
			player.getPacketSender().sendMessage("<img=10>@blu@"+player.getUsername()+" you have received 20 Raids One Points!");
			return;
		}
		
		if (chance > 95) {
			player.getPointsHandler().incrementRaidsOnePoints(15);
			player.getPacketSender().sendMessage("<img=10>@blu@"+player.getUsername()+" you have received 15 Raids One Points!");
			return;
		}
		
		if (chance > 50) {
			player.getPointsHandler().incrementRaidsOnePoints(10);
			player.getPacketSender().sendMessage("<img=10>@blu@"+player.getUsername()+" you have received 10 Raids One Points!");
			return;
		}
