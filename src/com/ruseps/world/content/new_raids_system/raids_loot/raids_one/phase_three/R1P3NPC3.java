package com.ruseps.world.content.new_raids_system.raids_loot.raids_one.phase_three;
 ...
 *
 */
public class R1P3NPC3 extends NPC {
	 ...
	 * The npc id.
	 */
	public static final int FIRST_NPC_ID = RaidsConstants.R1P3_SEVENTH_NPC_ID;
	
	public R1P3NPC3(Position position) {
