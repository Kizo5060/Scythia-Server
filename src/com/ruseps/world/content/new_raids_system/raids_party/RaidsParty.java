package com.ruseps.world.content.new_raids_system.raids_party;
...
import com.ruseps.world.content.minigames.MinigameAttributes.RaidsAttributes;
...
public class RaidsParty {
	...
	public void add(Player p) {
		...
		/*if (p.getLocation() != Locations.Location.RAIDS_ONE_ENTRANCE || p.getLocation() != Locations.Location.RAIDS_TWO_ENTRANCE || p.isTeleporting()) {
			return;
		}*/
	...
	public void remove(Player p, boolean reset, boolean fromParty) {
		...
		p.getPacketSender().sendString(58009, "Create");
		int id = 58016;
		...
		p.getPacketSender().sendString(58002, "Raiding Party: @whi@0");
	...
	public void refreshInterface() {
		for (Player member : getPlayers()) {
			if (member != null) {
				member.getPacketSender().sendString(58009, "Invite");
				...
				member.getPacketSender().sendString(58002, "Raiding Party: @whi@" + getPlayers().size());
			}
		}
	}
	...
	public int getPlayersInRaidsLocation(RaidsParty party) 
	{
		...
		{
			if (member.getLocation().equals(Locations.Location.RAIDS_ONE_PHASE_ONE) 
					|| member.getLocation().equals(Locations.Location.RAIDS_ONE_PHASE_TWO)
					|| member.getLocation().equals(Locations.Location.RAIDS_ONE_PHASE_THREE)
					|| member.getLocation().equals(Locations.Location.RAIDS_TWO_PHASE_ONE)
					|| member.getLocation().equals(Locations.Location.RAIDS_TWO_PHASE_TWO)
					|| member.getLocation().equals(Locations.Location.RAIDS_TWO_PHASE_THREE)
					|| member.getLocation().equals(Locations.Location.RAIDS_THREE_PHASE_ONE)
					|| member.getLocation().equals(Locations.Location.RAIDS_THREE_PHASE_TWO)
					|| member.getLocation().equals(Locations.Location.RAIDS_THREE_PHASE_THREE)
					|| member.getLocation().equals(Locations.Location.RAIDS_THREE_PHASE_FOUR)
					|| member.getLocation().equals(Locations.Location.RAIDS_THREE_PHASE_FIVE)
					|| member.getLocation().equals(Locations.Location.RAIDS_FOUR_PHASE_ONE)
					|| member.getLocation().equals(Locations.Location.RAIDS_FOUR_PHASE_TWO)
					|| member.getLocation().equals(Locations.Location.RAIDS_FOUR_PHASE_THREE)
					|| member.getLocation().equals(Locations.Location.RAIDS_FIVE_PHASE_ONE)
					|| member.getLocation().equals(Locations.Location.RAIDS_FIVE_PHASE_TWO)
