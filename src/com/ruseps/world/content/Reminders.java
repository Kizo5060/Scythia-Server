...
public class Reminders {
	...
	private static final String[][] MESSAGE_DATA = { 
			...
			{"<img=2>@yel@[SERVER]@bla@ Make sure to read the forums for information www.SolaraScape.org"},
			...
			{"<img=2>@yel@[SERVER]@bla@ See where you stand on the Hiscores www.SolaraScape.org"},
