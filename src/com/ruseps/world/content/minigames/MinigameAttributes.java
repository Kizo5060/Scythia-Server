...
public class MinigameAttributes {
	...
	private final ValentinesAttributes valentinesAttributes = new ValentinesAttributes();
	...
	private final VaderZoneAttributes vaderZoneAttributes = new VaderZoneAttributes();
	private final DragonZoneAttributes dragonZoneAttributes = new DragonZoneAttributes();
	...
	public class VaderZoneAttributes {
		private int[] killcount = new int[1];
		private boolean enteredZone;
		...
		public void setHasEnteredRoom(boolean enteredRoom) {
			this.enteredZone = enteredRoom;
		}

	}
	public class DragonZoneAttributes {
		private int[] killcount = new int[1];
		private boolean enteredZone;
	...
	public class ValentinesAttributes {
		private boolean[] questParts = new boolean[4];
	...
	public ValentinesAttributes getValentinesAttributes() {
		return valentinesAttributes;
	}
	...
	public VaderZoneAttributes getVaderZoneAttributes() {
		return vaderZoneAttributes;
	}
	
	public DragonZoneAttributes getDragonZoneAttributes() {
		return dragonZoneAttributes;
	}
