...
public enum NPCTask {
    ...
    KILL_100_SNOWMAN("Kill 100 Beginner Snowman", 0, 5049, 100, new TaskReward(new Item(915, 2)), "Kill 100 Beginner Snowman", "They can be found at ::train"),
    KILL_250_SNOWMAN("Kill 250 Transformer Snowman", 1, 4990, 250, new TaskReward(new Item(915, 5), new Item(995, 10000000)), "Kill 150 Tranformed Snowman", "They can be found in the Monsters Teleport " );
