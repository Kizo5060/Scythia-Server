...
public final class RegionClipping {
	...
	public static boolean objectExists(GameObject object) {
		...
		boolean ezoneCrates = id == 34587 && pos.getX() == 3284 && pos.getY() == 2900
				|| id == 34587 && pos.getX() == 3283 && pos.getY() == 2900
				|| id == 34587 && pos.getX() == 3282 && pos.getY() == 2900
				|| id == 34587 && pos.getX() == 3374 && pos.getY() == 3082
				|| id == 34587 && pos.getX() == 3374 && pos.getY() == 3083;
		boolean crystalChest = id == 172 && pos.getX() == 2935 && pos.getY() == 2812;
		boolean SilverRaidsdoor = id == 3012 && pos.getX() == 1242 && pos.getY() == 1246;
		boolean SilverRaidsChest = id == 2044 && pos.getX() == 1245 && pos.getY() == 1249;
		boolean Fuser = id == 4002 && pos.getX() == 3279 && pos.getY() == 2896;
		boolean PlatRaidsdoor = id == 3000 && pos.getX() == 3098 && pos.getY() == 3936;
		boolean PlatRaidschest = id == 4001 && pos.getX() == 3096 && pos.getY() == 3939;
		boolean AoeZonesChest = id == 2006 && pos.getX() == 2721 && pos.getY() == 2856;
		boolean burntChest = id == 6420 && pos.getX() == 2935 && pos.getY() == 2813;
		...
		boolean homeObjects = id == 14367 && pos.getX() == 2931 && pos.getY() == 2812
				|| id == 14367 && pos.getX() == 2931 && pos.getY() == 2813
				|| id == 14367 && pos.getX() == 2931 && pos.getY() == 2815
				|| id == 14368 && pos.getX() == 2931 && pos.getY() == 2816
				|| id == 14367 && pos.getX() == 2931 && pos.getY() == 2817
				|| id == 14367 && pos.getX() == 2931 && pos.getY() == 2818
				|| id == 14368 && pos.getX() == 2931 && pos.getY() == 2819
				|| id == 3192 && pos.getX() == 3260 && pos.getY() == 2866
				|| id == 14368 && pos.getX() == 2931 && pos.getY() == 2814
				|| id == 2213 && pos.getX() == 3266 && pos.getY() == 2883 // banks
				|| id == 2213 && pos.getX() == 3267 && pos.getY() == 2884 // bank
				|| id == 2213 && pos.getX() == 3265 && pos.getY() == 2884; // bank
		...
		boolean Summoning = id == 28716 && pos.getX() == 3281 && pos.getY() == 2866;
		boolean mageBankLever = id == 5959 && pos.getX() == 3090 && pos.getY() == 3956;
		boolean well = id == 2654 && pos.getX() == 3262 && pos.getY() == 2889;
		boolean gypsyPortal = id == 13635 && pos.getX() == 3079 && pos.getY() == 3489;
		boolean altar1 = id == 409 && pos.getX() == 3258 && pos.getY() == 2877;
		boolean altar2 = id == 6552 && pos.getX() == 2947 && pos.getY() == 2831;
		boolean altar3 = id == 13179 && pos.getX() == 2948 && pos.getY() == 2823;
		boolean summoningLadder = id == 1746 && pos.getX() == 3091 && pos.getY() == 3492;
		boolean altar4 = id == 61 && pos.getX() == 3256 && pos.getY() == 2877;
		boolean bank1 = id == 3194 && pos.getX() == 1293 && pos.getY() == 1247;
		boolean bank2 = id == 3194 && pos.getX() == 1293 && pos.getY() == 1246;
		boolean bank3 = id == 4483 && pos.getX() == 1247 && pos.getY() == 1248;
		boolean bank4 = id == 4483 && pos.getX() == 1247 && pos.getY() == 1244;
		boolean bank5 = id == 4483 && pos.getX() == 1243 && pos.getY() == 1248;
		boolean bank6 = id == 4483 && pos.getX() == 1243 && pos.getY() == 1244;
		boolean bank7 = id == 2213 && pos.getX() == 3266 && pos.getY() == 2885;
		boolean theivestall5 = id == 4878 && pos.getX() == 3261 && pos.getY() == 2882;
		boolean theivestall4 = id == 4877 && pos.getX() == 3261 && pos.getY() == 2883;
		boolean theivestall3 = id == 4876 && pos.getX() == 3261 && pos.getY() == 2885;
		boolean theivestall2 = id == 4874 && pos.getX() == 3261 && pos.getY() == 2886;
		boolean theivestall1 = id == 4875 && pos.getX() == 3261 && pos.getY() == 2887;
	 ...
	 * @author Skwishy
	 * @param position
	 * The root position to start looking for objects that are close
	 * @param objName
	 * The object we are searching for
	 * @return
	 * The closest object with said name if one exists.
	 */
	public static GameObject getClosestObject(Position position, String objName) {
		final RegionClipping clipping = forPosition(position);
		if (clipping != null) {
			int height = position.getZ();
			if (height < 0 || height >= 4)
			...
			for (int h = 0; h < clipping.gameObjects.length; h++) {
				for (int x = 0; x < clipping.gameObjects[height].length; x++) {
					for (int y = 0; y < clipping.gameObjects[height][x].length; y++) {
						GameObject gameObject = clipping.gameObjects[h][x][y];
						if (gameObject != null) {
							String name = gameObject.getDefinition().getName();
							if (name != null && name.equalsIgnoreCase(objName)) {
								if (lastPos == null) {
									lastPos = gameObject.getPosition();
								} else {
									if (lastPos.getDistance(position) > gameObject.getPosition()
			...
			if (lastPos != null) {
				return RegionClipping.getGameObject(lastPos);
			}
		}
		return null;
	}
