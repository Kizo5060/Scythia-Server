...
public class DragonLoot extends NPC {
	 ...
	 * The npc id.
	 */
	public static final int RED_NPC_ID = 175;
	
	public static final int GREEN_NPC_ID = 164;
	
	public static final int PURPLE_NPC_ID = 165;
	
	public static final int BLUE_NPC_ID = 163;
	 ...
	 *            The position.
	 */
	public DragonLoot(Position position) {
