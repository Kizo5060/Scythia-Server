 ...
 *
 */
public class InheritedLoot extends NPC {
	
	public static int spawnTime = 10;
	
	public static int[] COMMONLOOT = {14793, 19994, 20106, 20108, 20110, 20112, 20114, 20116,  };
	public static int[] MEDIUMLOOT = { 20100, 20102, 20104, 915};
	public static int[] RARELOOT = { 18448, 18950, 18918, 18936, 18920, 18057, 10942, 10934 };
	public static int[] SUPERRARELOOT = { 2701, 2702, 2704, 2705, 2706, 2707, 2708, 10935, 18065, 21055, };
	 ...
	 *            The position.
	 */
	public InheritedLoot(Position position) {
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		World.sendMessage("<img=17> @red@<shad=1>"+player.getUsername()+ " @mag@received a loot from the @gre@Inherited's Girl!");
		...
		if(isWearingCollector) {
			...
			GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(19990, Misc.inclusiveRandom(5, 10)), pos, player.getUsername(), false, 150, true, 200));
