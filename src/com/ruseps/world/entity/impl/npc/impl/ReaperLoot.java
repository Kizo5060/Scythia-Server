 ...
 *
 */
public class ReaperLoot extends NPC {
	
	public static int spawnTime = 10;
	
	public static int[] COMMONLOOT = { 14793, 19994 };
	public static int[] MEDIUMLOOT = { 8863, 8864, 8865, 79, 81, 82, 83, 8518, 8666, 915, 18057, 10942 };
	public static int[] RARELOOT = { 2793, 2791, 2792, 2794, 2797, 10934, 21055  };
	public static int[] SUPERRARELOOT = { 1009, 1686, 1015, 1667, 1013, 10935, 18061, 18961, 18958 };
	public static int [][] allLoot = {RARELOOT ,SUPERRARELOOT};
	/**
	 * The npc id.
	 */
	public static final int NPC_ID = 6820;
	 ...
	 *            The position.
	 */
	public ReaperLoot(Position position) {
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		World.sendMessage("<img=469> <col=dbffba><shad=1>"+player.getUsername()+ " received a loot from the @gre@NexArch's Shooter!");
		...
		if(isWearingCollector) {
			player.addItemToAny(19992, Misc.inclusiveRandom(100, 250));
		}else
			GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(19992, Misc.inclusiveRandom(100, 250)), pos, player.getUsername(), false, 150, true, 200));
	...
	public static final void loadDrops() {
		...
		items.put(19992, new NpcDropItem(19992, new int[] { 100 }, 0));
