...
public class Position {
	...
	public String toSimpleString() {
		...
		int mapObject = RegionClipping.get(regionId).getRegionData().getMapObject();
		int mapGround = RegionClipping.get(regionId).getRegionData().getMapGround();
		return "new Position(" + x + ", " + y + ", " + z + ") - Region: " + regionId + " RegionObject: " + mapObject + ".gz" + " RegionMap: " + mapGround + ".gz";
	}
